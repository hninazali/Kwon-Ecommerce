...
//    PersonalCartEntity createPersonalCartCard(PersonalCartEntity newPersonalCartEntity) throws InputDataValidationException, CreateNewPersonalCartException;
    ...
    void checkOutCart(Long personalCartId) throws PersonalCartNotFoundException;
}
