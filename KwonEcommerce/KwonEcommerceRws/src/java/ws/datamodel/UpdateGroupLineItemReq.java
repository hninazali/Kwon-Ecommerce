 ...
 * @author User
 */
public class UpdateGroupLineItemReq 
{
    ...
    public UpdateGroupLineItemReq() {
    }

    public UpdateGroupLineItemReq(String username, String password, GroupCartEntity groupCart, OrderLineItemEntity lineItem, Integer newQty) {
